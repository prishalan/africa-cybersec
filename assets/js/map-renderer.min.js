window.MapRenderer = (function () {
  class MapRenderer {
    constructor(containerId) {
      ...
      this.activeFilters = { categories: new Set(), tags: new Set() };
    }
...
class="more-info-link">More Information →</a>`
    ...
    async initializeParticles() {
      try {
        const response = await fetch("/africa-cybersec/assets/data/particlesjs-config.json");
